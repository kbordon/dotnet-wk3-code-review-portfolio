...
namespace Portfolio.Migrations
{
    ...
    [Migration("20180123220452_AddBlogRoles")]
    partial class AddBlogRoles
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Portfolio.Models.BlogRole", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("BlogRole");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Portfolio.Models.BlogUser")
                        .WithMany("Claims")
